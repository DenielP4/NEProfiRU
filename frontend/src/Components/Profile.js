            ...
            <Row  className="mb-3 mt-3">
                    ...
                    <Col>
                        <Card style={{backgroundColor:'#eed39b', boxShadow: " 3px 3px 3px #1d1818"}} className="d-flex flex-column align-items-center login">
                            ...
                            <Card.Body>
                                <Stack gap={1}>
                                    <Row className="mb-2">
                                        <Form.Label className="editTextTeacher">Варинаты проведения занятий следующие</Form.Label>
                                    ...
                                    <Row className="mb-2">
                                        <Form.Group as={Col} controlId="formGridEmail">
                                            <Form.Label className="editTextTeacher">Репетитирую</Form.Label>
                                    ...
                                    <Row className="mb-2">
                                        <Form.Group as={Col} controlId="formGridEmail">
                                            <Form.Label className="editTextTeacher">Стоимость занятий за час</Form.Label>
                                    ...
                                    <Row className="mb-2">
                                        <Form.Group as={Col} controlId="formGridEmail">
                                            <Form.Label className="editTextTeacher">Мое образование</Form.Label>
                                    ...
                                    <Row className="mb-2">
                                        <Form.Group as={Col} controlId="formGridEmail">
                                            <Form.Label className="editTextTeacher">О себе</Form.Label>
                                            <Form.Control type="text" as="textarea"
                ...
                <Col>
                    ...
                    <Card style={{backgroundColor:'rgba(50,84,232,0.57)', padding:40, borderRadius:10}} className="d-flex flex-column align-items-center login">
                        ...
                        <Row className="mb-2">
                            <Form.Label className="editText" style={{fontSize:20}}>Отметьте варианты связи с вами</Form.Label>
                            <Form.Group as={Col} controlId="formGridEmail">
                                <Form.Check
                                    className="editText"
                                    label="telegram"
                    ...
                    {!isTeacher &&
                        <Row>
                            <Card style={{backgroundColor:'rgba(135,158,240,0.57)', padding:40, borderRadius:10}} className="d-flex flex-column align-items-center login mt-4">
                                <Row>
                                    <h1 style={{color:'#fff', fontWeight:"bold"}} className="text-center">Ваши задания</h1>
                                </Row>
                            </Card>
                        </Row>
                    }
